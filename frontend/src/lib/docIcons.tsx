 ...
 * docIcons.tsx
 *
 * Maps Lucide icon names (as stored in wiki frontmatter `icon` field) to
 * inline SVG React nodes. These match the icons used in dashboard-mockup.html
 * verbatim.
 *
 * Usage:
...
const fallback = ({ size = 16 }: IconProps): ReactNode => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" />
    <path d="M14 2v4a2 2 0 0 0 2 2h4" />
  </svg>
...
export function docIcon(name: string | null | undefined, size = 16): ReactNode {
  const fn = name ? (icons[name] ?? fallback) : fallback
  return fn({ size })
}
